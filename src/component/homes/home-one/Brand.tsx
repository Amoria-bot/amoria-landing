            ...
            <div className="row g-0">
               <div className="col-lg-12">
                  <div className="brand-title text-center">
                     <h6 className="title">Important Information</h6>
                  </div>
               </div>
            </div>
			 <div className="brand-item-wrap style2">
				 ...
				 {/*   ))}*/}
				 {/*</Slider>*/}
				 <h2 className="hero-countdown-wrap-title">
					 All communication takes place in the Telegram app, where your data and conversations are completely confidential.
					 <br/><br/>
					 All characters are fictional and generated by AI. Any resemblance to real people is purely coincidental.
					 <br/><br/>
					 The platform is exclusively for users aged 18 and older.
				 </h2>
			 </div>
		 </div>
	  </div>
