               ...
               <div className="row gy-4 justify-content-between align-items-center">
                  <div className="col-xl-5 col-lg-4">
                     <div className="social-btn justify-content-center justify-content-lg-start">
                        <Link href="https://t.me/amoria_community" target="_blank" rel="noopener noreferrer">
                           <i className="fab fa-telegram-plane"></i>
                        </Link>
                        <Link href="https://x.com/amoriachat" target="_blank" rel="noopener noreferrer">
                        ...
                        <Link href="https://www.instagram.com/amoriachat/" target="_blank" rel="noopener noreferrer">
                           <i className="fab fa-instagram"></i>
                        </Link>
                        <Link href="https://www.youtube.com/@Amoriachat" target="_blank" rel="noopener noreferrer">
                           <i className="fab fa-youtube"></i>
                        </Link>
                        <Link href="https://medium.com/@amoriachat" target="_blank" rel="noopener noreferrer">
